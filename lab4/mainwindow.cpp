...
/*
 * Нажимаем кнопку и открывается файл команд. Из него читается кол-во строк.
 * Затем в цикле фор выполняются построчно команды - читается одна строка, определяется что это за команда и какие у неё аргументы.
 * Отправка в функцию выполнения команды.
 */
